    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/4946515/pexels-photo-4946515.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop)'
          }}
        />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="text-lg md:text-xl text-primary-100/90 mb-12 max-w-2xl mx-auto leading-relaxed">
            <span className="font-body font-light tracking-[0.05em]">Felipe Navarro's personal archive of Extra Añejos—now offered privately for the first time.</span>
          </p>
