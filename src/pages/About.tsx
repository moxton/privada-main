    ...
    <div className="pt-24 pb-16">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/4946684/pexels-photo-4946684.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop)'
          }}
        />
      ...
      <section className="py-24 px-6 bg-primary-800">
        <div className="max-w-4xl mx-auto text-center">
          <blockquote className="font-serif text-3xl md:text-4xl font-light text-primary-100 mb-8 italic leading-relaxed">
            "I never meant to share these barrels. They were for me."
          </blockquote>
          <cite className="text-gold-500 font-medium tracking-wider text-lg">
            – Felipe Navarro
          </cite>
          
          <p className="text-lg md:text-xl text-primary-100/80 mt-12 leading-relaxed">
            <span className="font-body font-light tracking-[0.05em]">This is a private stash, aged in silence. Bottled not for scale, but for soul.</span>
          </p>
        </div>
      </section>
